 ...
 * generated in the jaxws.documentstyle package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://DocumentStyle.JAXWS/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://DocumentStyle.JAXWS/", "getHelloWorldAsStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxws.documentstyle
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://DocumentStyle.JAXWS/", name = "getHelloWorldAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://DocumentStyle.JAXWS/", name = "getHelloWorldAsStringResponse")
